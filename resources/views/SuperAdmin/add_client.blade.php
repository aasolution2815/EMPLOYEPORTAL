        ...
        <div id="textbox" class="">
            ...
            <p class="alignright margin-top_10">
                <a href="javascript:history.back()"><span class="btn_with_icon" style="margin-right: 15px;"><i  class="feather icon-corner-up-left  small_icon_left"></i>
                     Back </span></a>
                <span class="btn_with_icon c1" style="margin-right: 15px;"><i
                        class="feather icon-file-plus  small_icon_left"></i> Import </span>
                <span class="btn_with_icon c2 hide" style="margin-right: 15px;"><i
                        class="feather icon-plus-circle  small_icon_left"></i> Form </span>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                        <div style="margin-top: 30px;">
                            ...
                            <div class="inputWithIcon">
                                <input type="text" id="company_name" class="input_text margin_top_0 form-control"
                                    placeholder="Company Name" required="" data-parsley-trigger="blur"
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                        <div style="margin-top: 30px;">
                            ...
                            <div class="inputWithIcon">
                                <input type="text" id="empcode_format" class="input_text margin_top_0 form-control"
                                    placeholder="Employee Code" required="" data-parsley-trigger="blur"
                                    data-parsley-required-message="Required">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                        <div>
                            ...
                            <div class="inputWithIcon">
                                <input type="text" id="client_prefix" class="input_text margin_top_0 form-control"
                                    placeholder="Prefix" required="" data-parsley-trigger="blur"
                                    data-parsley-required-message="Required">
                                <i class="feather icon-user inside_input_icon"></i>
                                {{-- <span class="error_input_patch">
                                    <i class="feather icon-x error_inputcolor"><label for="name"
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                        <div>
                            ...
                            <div class="inputWithIcon">
                                <input type="password" id="user_password" class="input_text margin_top_0 form-control"
                                    placeholder="Password" autocomplete="new-password" required=""
                                    data-parsley-trigger="blur" data-parsley-required-message="Required"
                                    data-parsley-pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z])(?=.*[@#_-]).{6,}"
                                    data-parsley-pattern-message="Must Contain 6 Charcter Atlest 1 Uper Case ,Lower Case, Number, and Special Charter @,#,_,-">
                        ...
                        <div>
                            ...
                            <div class="inputWithIcon">
                                <input type="date" iname="startdate" id="startdate" required=""
                                    data-parsley-trigger="blur" data-parsley-required-message="Required"
                                    class="input_text margin_top_0 form-control" placeholder="Your name" value="{{date('Y-m-d')}}">
                        ...
                        <div>
                            ...
                            <div class="inputWithIcon">
                                <input type="number" id="no_of_days" disabled onkeyup="getDate(this)" required=""
                                    data-parsley-trigger="blur" data-parsley-required-message="Required"
                                    class="input_text margin_top_0 form-control" placeholder="No. of Days / Month / Year">
                                <i class="feather icon-hash inside_input_icon"></i>
                                {{-- <span class="error_input_patch">
                                    <i class="feather icon-x error_inputcolor"><label for="name"
                                            class="error_label">Name Taken</label></i>
